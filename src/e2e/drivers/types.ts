...
export interface DriverCaps {
   ...
   *  the session stays mid-turn after the last gate resolves even though the work is done. That is
   *  also why Kiro registers no turn-end review — the case asks for one by hand instead. */
